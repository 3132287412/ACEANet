...
from model.commons import Weights_Normal, VGG19_PercepLoss
from model.Trans import MyNet
...
parser.add_argument("--dataset_path", type=str, default= "./data/EUVP/", help="path of train images")
...
parser.add_argument("--ckpt_interval", type=int, default=20, help="Every 10 epoch of saving model checkpoints")
parser.add_argument("--num_epochs", type=int, default=801, help="number of epochs of training")
...
for epoch in range(epoch, num_epochs):
    for i, batch in enumerate(dataloader):
        ...
        fake, fake_128 = out[0], out[1]
        ll_128= ll[0]

        # Total loss
        loss_rec = 15 * (L1_G(fake, gt) + 1 / 4 * L1_G(fake_128, gt_128))  # reconstruction loss
        loss_fre = L1_G(ll_128, gll_128)  # frequency loss
